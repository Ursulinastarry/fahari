          ...
          return (
            ...
            >
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">Booking: {b.bookingNumber}</p>
                <p className="text-sm text-gray-600 dark:text-gray-400">Salon: {b.salonName}</p>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Service: {b.serviceName}</p> {/* New line */}

                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Appointment: {formatEAT(b.slotStartTime)}
                </p>
                <p className="text-sm text-gray-600 dark:text-gray-400">Created: {formatEAT(b.createdAt)}</p>
                <p className="text-sm text-gray-600 dark:text-gray-400">

...
>
  ...
  <div className="relative z-10">
    ...
    <p className="text-lg md:text-xl text-gray-200 dark:text-white max-w-2xl mb-8">
...
>
  ...
  Register your salon
      ...
      <section className="py-20 px-10">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {[
            ...
            >
              <p className="text-gray-600  dark:text-white italic mb-4">“{review.text}”</p>
      ...
      <section className="py-20 text-center bg-gradient-to-r from-purple-600 to-pink-600 text-white">
        ...
        <button className="px-8 py-4 bg-white dark:bg-gray-900 text-purple-700 rounded-2xl shadow-lg hover:bg-gray-100 transition">
          Start with AI Assistant
        </button>
      </section>

      {/* Footer */}
      <footer className="bg-gray-100 text-gray-600  dark:text-white py-10 text-center">

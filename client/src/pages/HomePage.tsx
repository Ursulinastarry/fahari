...
>
  ...
  Register your salon
      ...
      {/* How It Works */}
      <section className="grid md:grid-cols-3 gap-8 px-10 py-20 bg-white shadow-inner">
        {[
          {
      ...
      <section className="py-20 text-center bg-gradient-to-r from-purple-600 to-pink-600 text-white">
        ...
        <button className="px-8 py-4 bg-white text-purple-700 rounded-2xl shadow-lg hover:bg-gray-100 transition">
          Start with AI Assistant
        </button>
      </section>

      {/* Footer */}
      <footer className="bg-gray-100 text-gray-600 py-10 text-center">
